...
function SceneModule()
    local on_load_wait_scene, on_restart_scene, on_load_scene, on_unload_scene, SCENE_ID, loaded_scenes, wait_load_scene, last_loading_scene, last_scene, is_restarting_scene, _wait_ready_manager, _unload_last_scene
    function on_load_wait_scene(message_id)
        if message_id ~= to_hash("MANAGER_READY") or wait_load_scene == "" then
            return
        end
    ...
    local function load(name, wait_ready_manager, unload_last_scene)
