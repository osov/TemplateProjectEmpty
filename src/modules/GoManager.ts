...
export function GoManager() {
    ...
    function draw_debug_intersect(debug_resource = 'assets/x.goc') {
        set_prefab(debug_resource, () => {
            ...
            tmp_items = [];
            tmp_items.push(make_go(a), make_go(b), make_go(c), make_go(d));
        });
    }
    ...
    return {
        do_message, on_click, set_prefab, make_go, set_render_order, get_render_order, do_move_anim, do_scale_anim, do_fade_anim, do_move_anim_hash, do_fade_anim_hash, do_scale_anim_hash,
